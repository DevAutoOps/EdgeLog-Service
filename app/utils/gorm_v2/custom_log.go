...
//  Custom log format ,  yes  gorm  The built-in log is intercepted and rewritten 
...
//  Attempt to override internally related formatting variables from the outside 
...
//  definition  6  A function modifies an internal variable 
